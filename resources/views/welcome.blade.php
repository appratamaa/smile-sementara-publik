        ...
        <div class="bg-white text-black/50 dark:bg-black dark:text-white/50">
            <div class="relative min-h-screen flex flex-col items-center justify-center selection:bg-[#FF2D20] selection:text-white">
                <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                    <header class="grid grid-cols-1 items-center gap-2 py-10">
                        <div class="flex justify-between items-center">
                            <div class="flex justify-start">
                                <img src="image/SMILE LOGO.png" alt="Logo" class="h-12 w-auto lg:h-16">
                            </div>
                            <nav class="flex space-x-8">
                                <a href="{{ url('/') }}" class="text-black dark:text-white hover:text-gray-700 dark:hover:text-gray-300 transition">Beranda</a>
                                <a href="{{ url('/artikel') }}" class="text-black dark:text-white hover:text-gray-700 dark:hover:text-gray-300 transition">Artikel</a>
                                <a href="{{ url('/chat-dokter') }}" class="text-black dark:text-white hover:text-gray-700 dark:hover:text-gray-300 transition">Chat Dokter</a>
                                <a href="{{ url('/informasi') }}" class="text-black dark:text-white hover:text-gray-700 dark:hover:text-gray-300 transition">Informasi</a>
                                @if (Route::has('login'))
                                    @auth
                                    ...
                                    @else
                                        <a href="{{ route('login') }}" class="rounded-[15px] bg-black px-4 py-2 text-white transition hover:bg-gray-800 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#FF2D20]">Log in</a>
                                    @endauth
                                @endif
                            </nav>
                        </div>
                    ...
                    <main class="mt-6">
                        <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                            <div class="lg:col-span-1 text-left">
                                <h1 class="text-[32px] font-bold">Klinik drg. Robet Agustinus Pangandaran</h1>
                                <p class="mt-4 text-[24px]">
                                    Memberikan pelayanan kesehatan gigi dan mulut terbaik untuk keluarga Anda. Kami berkomitmen pada <strong>kualitas</strong>, <strong>kenyamanan</strong>, dan <strong>kepercayaan</strong>.
                                </p>
                                <button class="mt-6 border border-black text-black px-4 py-2 rounded-md hover:bg-black hover:text-white transition">
                                    Buat Janji
                                </button>
                            </div>
                            <div class="lg:col-span-1 flex justify-end">
                                <img src="image/Profil Dokter.png" alt="Profil Dokter" class="rounded-tr-[300px] rounded-tl-[300px] rounded-br-[0px] rounded-bl-[0px]" style="width: 350px; height: 400px;">
                            </div>
                        </div>
                        ...
                        <style>
                            ...
                            .staff-name {
                                margin-top: -40px; /* Adjust margin to position near the image */
                            }
                        ...
                        <!-- Profil Dokter Gigi -->
                        <div class="mt-8 grid gap-6 lg:grid-cols-2 lg:gap-8 profile-section content">
                            <div class="lg:col-span-1 text-left">
                                <h1 class="text-[32px] font-bold">Profil Dokter Gigi</h1>
                                <img src="image/Profil Dokter.png" alt="Profil Dokter Gigi" class="rounded-tr-[300px] rounded-tl-[300px] rounded-br-[0px] rounded-bl-[0px]" style="width: 350px; height: 400px;">
                            </div>
                            <div class="lg:col-span-1 text-left doctor-name">
                                ...
                                <p class="mt-4">
                                    Drg. Robet Agustinus adalah seorang dokter gigi berpengalaman yang telah melayani pasien selama lebih dari 10 tahun. Beliau menyelesaikan pendidikan dokter gigi di Universitas Indonesia dan melanjutkan pelatihan spesialis di bidang estetika dan perawatan gigi modern.
                                </p>
                        ...
                        <div class="mt-8 grid gap-6 lg:grid-cols-2 lg:gap-8 profile-section content">
                            <div class="lg:col-span-1 text-left">
                                ...
                                <p class="mt-4">
                                    Andini adalah asisten dokter gigi yang memiliki pengalaman lebih dari 5 tahun. Dengan sikap ramah dan perhatian, ia membantu memastikan setiap prosedur berjalan lancar serta memberikan kenyamanan maksimal kepada pasien.
                                </p>
                            </div>
                            <div class="lg:col-span-1 text-left">
                                <h1 class="text-[32px] font-bold">Profil Staf</h1>
                                <img src="image/Profil Dokter.png" alt="Profil Staf" class="rounded-tr-[300px] rounded-tl-[300px] rounded-br-[0px] rounded-bl-[0px]" style="width: 350px; height: 400px;">
                            </div>
                        </div>
                        <style>
                            #map {
                    ...
                    <footer class="mt-6 py-6" style="background: linear-gradient(to right, white, black, white); color: white;">
