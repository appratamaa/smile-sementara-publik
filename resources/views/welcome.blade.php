...
<body class="h-full">
    <div class="min-h-full">
        ...
        <main class="bg-white min-h-screen">
            <div class="relative bg-blue-800 pb-20 rounded-b-[200px]">
                <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row">
                    ...
                    <div class="flex-1 mb-6 lg:mb-0">
                        ...
                        <div class="grid grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-6 mt-12">
                            <!-- Pemeriksaan Gigi -->
                            <div class="flex flex-col items-center">
                                ...
                                <span class="text-sm mt-2 text-white text-center">Pemeriksaan</span>
                            </div>
                            ...
                            <div class="flex flex-col items-center">
                                ...
                                <span class="text-sm mt-2 text-white text-center">Scaling</span>
                            </div>
                            ...
                            <div class="flex flex-col items-center">
                                ...
                                <span class="text-sm mt-2 text-white text-center">Perawatan Gusi</span>
                            </div>
                            ...
                            <div class="flex flex-col items-center">
                                ...
                                <span class="text-sm mt-2 text-white text-center">Behel</span>
                            </div>
                            ...
                            <div class="flex flex-col items-center">
                                ...
                                <span class="text-sm mt-2 text-white text-center">Cabut Gigi</span>
                            </div>
                            ...
                            <div class="flex flex-col items-center">
                                ...
                                <span class="text-sm mt-2 text-white text-center">Tambal Gigi</span>
                            </div>
                            ...
                            <div class="flex flex-col items-center">
                                ...
                                <span class="text-sm mt-2 text-white text-center">Veneer</span>
                            </div>
                            ...
                            <div class="flex flex-col items-center">
                                ...
                                <span class="text-sm mt-2 text-white text-center">Implant</span>
                            </div>
                            ...
                            <div class="flex flex-col items-center">
                                ...
                                <span class="text-sm mt-2 text-white text-center">Gigi Palsu</span>
                            </div>
                            ...
                            <div class="flex flex-col items-center">
                                ...
                                <span class="text-sm mt-2 text-white text-center">Rontgen</span>
                            </div>
                            ...
                            <div class="flex flex-col items-center">
                                ...
                                <span class="text-sm mt-2 text-white text-center">Orthodonti</span>
                            </div>
                            ...
                            <div class="flex flex-col items-center">
                                ...
                                <span class="text-sm mt-2 text-white text-center">Bedah Mulut</span>
                            </div>
                        </div>
                                ...
                                <div class="bg-white p-6 rounded-lg shadow-lg max-w-lg w-full relative">
                                    ...
                                    <form id="appointmentForm" action="{{ route('appointments.store') }}" method="POST">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input type="text" name="nama" id="nama" class="w-full p-2 border rounded mt-1" placeholder="Masukkan nama Anda" required>
                                        </div>
                                        <div class="mb-4">
                                            <label for="tanggal" class="block text-gray-700">Tanggal</label>
                                            <input type="date" name="tanggal" id="tanggal" class="w-full p-2 border rounded mt-1" required>
                                        </div>
                                        <div class="mb-4">
                                            <label for="tujuan" class="block text-gray-700">Tujuan</label>
                                            <select name="tujuan" id="tujuan" class="w-full p-2 border rounded mt-1" required>
            ...
            <div class="text-center profile-section mb-6">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8 px-4 md:px-12">
                ...
                <div
                    ...
                    <p class="text-sm text-gray-500">Tips sederhana untuk menjaga kesehatan gigi sehari-hari.</p>
